...
// Intro + scale (localized) — updated supportive tone
const T = {
  en: {
  ...
  fr: {
    ...
    intro: 'Il n’y a pas de bonnes ou de mauvaises réponses. Vos réponses nous aident à proposer un point de départ et une courte trajectoire à essayer.',
  },
  ar: {
...
// Questions (EN + localized). Keep ASCII quotes for safety inside strings.
const QUESTIONS = [
  // CV
  {
    id: 'cv-1',
