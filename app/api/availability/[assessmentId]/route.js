 ...
 * Deterministic: try update; if no row, insert.
 */
export async function PUT(req, { params }) {
  try {
    ...
    return NextResponse.json({ data: Array.isArray(insData) ? insData[0] : insData }, { status: 200 });
  } catch (e) {
    // Echo the error so the UI can show it
