...
// Correct relative paths from app/results-demo → app/components/results
    ...
    gaps: [
      {
        ...
        hint:
          'Record a short (30–60s) example talking about a strong moment at work or study.',
      ...
      },
      {
        ...
        hint:
          'Upload or record one example that shows how you helped a customer or learner.',
      ...
      },
      {
        ...
        href: null, // disabled button (coming soon)
      },
    ],
  };
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: 20, fontSize: 12, color: '#666' }}>
        <p>
          <strong>Note:</strong> This is a demo view using example data. We’ll wire
          this to your real results object next.
        </p>
      </div>
    </div>
  );
